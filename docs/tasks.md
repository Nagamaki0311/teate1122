...
| T-009 | ホームページ構成・ナビゲーション改善（SNS中段移動/ハンバーガーメニュー修正/商品紹介削除・作品紹介への拡張性/情報設計整理/アニメーション追加） | 高 | 実装中 | developer | 5構成（/about, /activities, /contact, /privacy, /）へ再編。/gallery統合・/candles削除・works予約・SNSデータ駆動化・ダイアログ式メニュー・CSSパーティクル。User承認済み（D-009参照、Instagram URL: https://www.instagram.com/teate1122） |
